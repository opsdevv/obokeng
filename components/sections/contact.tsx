...
const WHATSAPP_NUMBER = "26774521205"
const WHATSAPP_MESSAGE = "Hi! I came across your portfolio and would like to connect."
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        >
          <a
            ...
            className="flex flex-col items-center justify-center gap-4 bg-[#1c1c1c] p-8 rounded-lg border border-[#2e2e2e] hover:border-brand/50 hover:bg-[#232323] transition-all duration-300 group"
          >
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] group-hover:scale-110 transition-transform">
              <svg
            ...
            <div className="text-center">
              <h3 className="text-base font-semibold text-[#ecedee] mb-1">Chat on WhatsApp</h3>
              <p className="text-sm text-[#9ba1a6]">Let&apos;s connect! I typically reply within a few hours.</p>
            </div>
          </a>
        </div>
      </div>
